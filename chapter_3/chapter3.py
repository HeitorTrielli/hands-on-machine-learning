...
cv_socre_dummy = cross_val_score(dummy_clf, X_train, y_train_5, cv = 3, scoring = "accuracy")
...
y_scores_sklearn = cross_val_predict(sgd_clf, X_train, y_train_5, cv = 3, method = 'decision_function')
...
idx_for_90_precision = (precisions >= 0.90).argmax() # Returns the first index that obbeys the condition
